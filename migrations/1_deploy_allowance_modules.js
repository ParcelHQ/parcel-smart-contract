...
const MULTISIG_ADDRESS = "0xA35DAcCCE0e52F16946cCce01267b985A6239eCE"
...
module.exports = function(deployer, network, accounts) {
  ...
  deployer.then(async () => {
    ...
    await automationModule.transferOwnership(MULTISIG_ADDRESS, {from: accounts[0]});
    console.log("Multisig set as owner");
